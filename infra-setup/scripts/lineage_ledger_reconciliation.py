...
def main() -> int:
    ...
    with pg_conn.cursor() as cur:
        try:
            ...
            # Same tolerance lineage_seq_udf.py's own initialize() documents:
            # CREATE ... IF NOT EXISTS isn't race-free, and this script may
            # run against a schema/table real dbt processes already created.
            pass
