...
with base as (
    ...
    select * from {{ ref('br_observations') }}
...
{% set checks = {
    ...
    'missing_value':      'value is not null',
    'future_observation': 'observed_at <= current_timestamp'
} %}
...
select
    ...
    {{ lineage_columns('b.observation_id', 'b.cdc_source_ts_ns') }}
from base b
